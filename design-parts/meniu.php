...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.php">Puslapiai <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <?php
             if(isset($_COOKIE["prisijungti"])) { 
                echo "<form action='meniu.php' method ='get'>";
                echo "<button class='btn btn-outline-success my-2 my-sm-0' type='submit' name='logout'>Logout</button>";
                echo "</form>";
